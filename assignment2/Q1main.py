...
##stores the outputs from simpson and trapezoidal rule
...
print("trapezoidal rule -->\t",t[0])
print("n=10")
print("simpson rule -->\t",s[1])
print("trapezoidal rule -->\t",t[1])
print("n=100")
print("simpson rule -->\t",s[2])
print("trapezoidal rule -->\t",t[2])
print("n=1000000")
print("simpson rule -->\t",s[3])
print("trapezoidal rule -->\t",t[3])
